...
/**
 * wallet_invoice_all - Return a tal_arr of invoices.
 *
 * @ctx - the context to allocate from
 * @wallet - the wallet being queried
 *
 * Always returns some non-null array.
 */
struct invoice *wallet_invoice_all(const tal_t *ctx,
